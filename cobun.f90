...
parameter(S=0.65,jmax=1000,nmax=200000,dk=0.005,A=exp(10.),Fmax1=48.,Fmax2=51.,m=1.)
...
V1dot=-gam*V1+(k/m)*(X2-X1)+fHB1/m+noise(n)
V2dot=-gam*V2+(k/m)*(X1-X2)+fHB2/m+noise(n)

X1dot=V1
X2dot=V2
Xa1dot=(kgs/lambdaa)*(X1-Xa1-D*Po1)-(Fmax1/lambdaa)*(1.-S*Po1)+noise(n)
Xa2dot=(kgs/lambdaa)*(X2-Xa2-D*Po2)-(Fmax2/lambdaa)*(1.-S*Po2)+noise(n)
